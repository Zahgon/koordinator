...
func (bld *Builder) RegisterAll(b *Builder) *Builder { _ = "STUB: not implemented"; return nil }

// AddToScheme adds all registered types to s.
func (bld *Builder) AddToScheme(s *runtime.Scheme) error { _ = "STUB: not implemented"; return nil }

// Build returns a new Scheme containing the registered types.
func (bld *Builder) Build() (*runtime.Scheme, error) { _ = "STUB: not implemented"; return nil, nil }

...
func CopyFlags(source *flag.FlagSet, target *flag.FlagSet) { _ = "STUB: not implemented"; return }
...
func AddOptions(options interface{}, prefix string) bool { _ = "STUB: not implemented"; return false }
...
// exported.
func parseDefault(value interface{}, name, def string) { _ = "STUB: not implemented"; return }

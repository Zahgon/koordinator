...
func (c *ResourceThresholdChecker) ConfigParamValid() error { _ = "STUB: not implemented"; return nil }

func (c *ResourceThresholdChecker) initConfig() error { _ = "STUB: not implemented"; return nil }

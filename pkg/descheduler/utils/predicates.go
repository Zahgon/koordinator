...
func NodeSelectorsEqual(n1, n2 *corev1.NodeSelector) bool { _ = "STUB: not implemented"; return false }
...
func TolerationsEqual(t1, t2 []corev1.Toleration) bool { _ = "STUB: not implemented"; return false }
